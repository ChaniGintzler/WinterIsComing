System.register(["@angular/core", "./profiles.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, profiles_service_1, ProfilesComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ProfilesComponent = class ProfilesComponent {
            };
